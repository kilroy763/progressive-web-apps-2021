...
async function BrBa(req,res) {
    ...
    res.render('breakingbad', {data:data, pageTitle: "Breaking Bad"});
 }

 async function Saul(req,res) {
    const data = await fetcher.fetchDataSaul()
    res.render('saul', {data:data, pageTitle: "Better Call Saul"});
 }
 ...
 async function seasonSaul(req,res) {
     ...
     res.render('season', {data:data, pageTitle: "Season Better Call Saul"})
 }
 ...
 async function seasonBrBa(req,res) {
    ...
    const data = await fetcher.fetchDataSeasonSaul(urlSeason)
    res.render('season', {data:data, pageTitle:"Season Breaking bad"})
}
